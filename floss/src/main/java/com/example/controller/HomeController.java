...
import com.example.model.PaytmDetails;
...
public class HomeController {
	...
	public ModelAndView addUser(@RequestParam("username") String username, User user)
	{
	...
	@PostMapping("/login")
	public String login_user(@RequestParam("username") String username,@RequestParam("password") String password,ModelMap modelMap)
	{
   ...
   @PostMapping("/alogin")
   public String alogin_user(@RequestParam("username") String username,@RequestParam("password") String password,ModelMap modelMap)
    {  
